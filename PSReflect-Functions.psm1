...
Get-ChildItem "$($PSScriptRoot)\Enumerations\*" -Include '*.ps1' | ForEach-Object {
    . $_.FullName
}

# Loading Structures
. "$($PSScriptRoot)\Structures\LARGE_INTEGER.ps1"
Get-ChildItem "$($PSScriptRoot)\Structures\*" -Include '*.ps1' | Where-Object {
    $_.Name -ne "FILE_BASIC_INFORMATION.ps1" -and `
    $_.Name -ne "TOKEN_ACCESS_INFORMATION.ps1" -and `
    $_.Name -ne "CLAIM_SECURITY_ATTRIBUTES_INFORMATION.ps1" -and `
    $_.Name -ne "WINTRUST_DATA.ps1" -and `
    $_.Name -ne "OBJECT_ATTRIBUTES.ps1" -and `
    $_.Name -ne "CLAIM_SECURITY_ATTRIBUTE_V1.ps1" -and `
    $_.Name -ne "LUID_AND_ATTRIBUTES.ps1" -and `
    $_.Name -ne "TOKEN_PRIVILEGES.ps1" -and `
    $_.Name -ne "LARGE_INTEGER.ps1"
...
Get-ChildItem $PSScriptRoot |
    Where-Object { $_.PSIsContainer -and ($_.Name -ne 'Enumerations' -and $_.Name -ne 'Structures') } |
